...
/**
    ...
    public static void main(String[] args) {
        DijkstrasShortestPathAdjacencyList test = new DijkstrasShortestPathAdjacencyList(6);
        test.addEdge(0,1,3);
        test.addEdge(0,2,1);
        test.addEdge(1,3,1);
        test.addEdge(2,1,1);
        ...
        test.addEdge(4,3,1);
        test.addEdge(4,5,10);
        System.out.println(test.dijkstra(0,5));
        System.out.println(test.reconstructPath(0,5));
    }
}*/
